...
const tI18nPhrase Phrases[] = {
  ...
  { "Show exif informations from image", // English
    ...
    "", // Norwegian
    "N‰yt‰ kuvien Exif-tiedot", // Finnish
    "", // Polish
  ...
  { "Could not parse exif maker note!", // English
    ...
    "", // Norwegian
    "Exif-tiedon analysointi ep‰onnistui!", // Finnish
    "", // Polish
  ...
  { "Could not load exif data from image!", // English
    ...
    "", // Norwegian
    "Exif-tiedon lukeminen ep‰onnistui!", // Finnish
    "", // Polish
